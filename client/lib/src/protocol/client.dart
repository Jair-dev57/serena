...
/// {@category Endpoint}
class EndpointBlockEntry extends _i2.EndpointRef {
  EndpointBlockEntry(_i2.EndpointCaller caller) : super(caller);

  @override
  String get name => 'blockEntry';

  _i3.Future<List<_i5.BlockEntry>> getAllEntries() =>
      caller.callServerEndpoint<List<_i5.BlockEntry>>(
        'blockEntry',
        'getAllEntries',
        {},
      );
  ...
  _i3.Future<_i5.BlockEntry> createEntry(
    ...
    String? note,
  ) => caller.callServerEndpoint<_i5.BlockEntry>(
    'blockEntry',
    'createEntry',
    {
      'dateTime': dateTime,
  ...
  _i3.Future<_i5.BlockEntry> updateEntry(_i5.BlockEntry entry) =>
      caller.callServerEndpoint<_i5.BlockEntry>(
        'blockEntry',
        'updateEntry',
        {'entry': entry},
  ...
  _i3.Future<void> deleteEntry(int id) => caller.callServerEndpoint<void>(
    'blockEntry',
    'deleteEntry',
    {'id': id},
  );
...
/// {@category Endpoint}
class EndpointDifficultWord extends _i2.EndpointRef {
  EndpointDifficultWord(_i2.EndpointCaller caller) : super(caller);

  @override
  String get name => 'difficultWord';

  _i3.Future<List<_i8.DifficultWord>> getAllWords() =>
      caller.callServerEndpoint<List<_i8.DifficultWord>>(
        'difficultWord',
        'getAllWords',
        {},
      );
  ...
  _i3.Future<_i8.DifficultWord> createWord(
    String word,
    String? note,
  ) => caller.callServerEndpoint<_i8.DifficultWord>(
    'difficultWord',
    'createWord',
    {
      'word': word,
  ...
  _i3.Future<_i8.DifficultWord> updateWord(_i8.DifficultWord word) =>
      caller.callServerEndpoint<_i8.DifficultWord>(
        'difficultWord',
        'updateWord',
        {'word': word},
  ...
  _i3.Future<void> deleteWord(int id) => caller.callServerEndpoint<void>(
    'difficultWord',
    'deleteWord',
    {'id': id},
  );
...
/// {@category Endpoint}
class EndpointPracticeSession extends _i2.EndpointRef {
  EndpointPracticeSession(_i2.EndpointCaller caller) : super(caller);
  ...
  _i3.Future<int> getCurrentStreak() => caller.callServerEndpoint<int>(
    'practiceSession',
    'getCurrentStreak',
    {},
  );
...
class EndpointRecommendation extends _i2.EndpointRef {
  ...
  _i3.Future<_i12.RecommendationResult?> getRecommendation() =>
      caller.callServerEndpoint<_i12.RecommendationResult?>(
        'recommendation',
        'getRecommendation',
        {},
      );
...
class Client extends _i2.ServerpodClientShared {
  ...
  late final EndpointPracticeSession practiceSession;
