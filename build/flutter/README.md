...
* `serena_flet` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `serena-flet` - executable or bundle name on disk.
* `serena-flet` - display name shown in window titles and about app dialogs.
