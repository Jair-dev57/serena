...
--
-- Class BlockEntry as table block_entry
--
...
--
-- Class DifficultWord as table difficult_word
--
...
--
-- Class ExerciseProgress as table exercise_progress
--
...
--
-- Class PracticeSession as table practice_session
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serena_poc', '20260823223716933', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260823223716933', "timestamp" = now();
