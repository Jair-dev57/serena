...
import '../models/progress_extensions.dart';
...
class _GuidedExerciseScreenState extends State<GuidedExerciseScreen>
  ...
  Future<void> _markCompleted() async {
    ...
    final before = await ServerClient.instance.exerciseProgress
        .getProgressForExercise(widget.exercise.id);
    final after = await ServerClient.instance.exerciseProgress
        .incrementProgress(widget.exercise.id);
